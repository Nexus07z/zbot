  ...
  start: async (
    ...
    switch (inputCMD) {
      ...
      case "setgcname":
        ...
        try {
          ppgc = await Arashi.profilePictureUrl(m.from, "image");
        } catch {
          ppgc = botImage1;
        }

        await Arashi.groupUpdateSubject(m.from, text)
          .then((res) =>
            Arashi.sendMessage(
              m.from,
              {
      ...
      case "del":
        ...
        if (!isBotAdmin) {
          ...
          await doReact("📛");
          await Arashi.sendMessage(m.from, { delete: key });
        } else {
          if (!isAdmin) {
            await doReact("❌");
            return m.reply(
      ...
      case "demote":
        ...
        await doReact("📉");
        try {
          await Arashi.groupParticipantsUpdate(m.from, [userId], "demote").then(
            (res) =>
              Arashi.sendMessage(
                m.from,
                {
      ...
      case "grouplink":
        ...
        await doReact("🧩");
        let link = await Arashi.groupInviteCode(m.from);
      ...
      case "gc":
        ...
        if (text === "close") {
          await Arashi.groupSettingUpdate(m.from, "announcement").then((res) =>
            m.reply(`Group has been closed!`)
          );
        } else if (text === "open") {
          await Arashi.groupSettingUpdate(m.from, "not_announcement").then(
      ...
      case "promote":
        ...
        await doReact("💹");
        try {
          await Arashi.groupParticipantsUpdate(m.from, [userId], "promote").then(
            (res) =>
              Arashi.sendMessage(
                m.from,
                {
      ...
      case "remove":
        ...
        await Arashi.groupParticipantsUpdate(m.from, [users], "remove").then(
          (res) =>
            Arashi.sendMessage(
              m.from,
              {
      ...
      case "setppgc":
        ...
        let quotedimage = await Arashi.downloadAndSaveMediaMessage(quoted);
      ...
      case "setgcdesc":
        ...
        await Arashi.groupUpdateDescription(m.from, newGCdesc).then((res) =>
          Arashi.sendMessage(
            m.from,
            {
              image: { url: ppgc, mimetype: "image/jpeg" },
      ...
      case "revoke":
        ...
        if (m.from == "120363040838753957@g.us") {
          await doReact("❌");
          return m.reply(
            "Sorry, this command is not allowed in *Arashi Support Group* !\n\nYou are not allowed to change the support group link !"
          );
        }
        await doReact("💫");

        await Arashi.groupRevokeInvite(m.from).then((res) =>
          Arashi.sendMessage(
            m.from,
